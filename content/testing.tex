...
A monitor kimenetét összehasonlítjuk az elvárt kimenettel, amelyet kézzel állítunk össze figyelembe véve azt, hogy a szimulált rendszer működésének elméletben meg kell-e felelnie a követelménynek vagy sem.
...
Látható a kimenet végén lévő összegzésen, hogy egy teszt futott le, amely sikeres volt.
Ezen kívül megtekinthetőek a monitor működésének részletes folyamatai, például hogy milyen üzeneteket kapott, milyen állapotokba lépett át és egyes állapotoknak milyen kimenő átmeneteik voltak és a bejövő üzenet melyikre illeszkedett.
...
\begin{itemize}
    ...
    \item \textit{testNetworkWithErrors}, a \textit{sendUnsentEmail} üzenet után egy \textit{logout} üzenetet küldünk a monitornak és azt vizsgáljuk képes-e detektálni ezt a hibát.
...
A tesztesetek a monitor hiba detektáló képeségét tesztelik.
...
Ezen kívül azt is vizsgáljuk, hogy a generált monitor képes-e több óraváltozó kezelésére is.
