...
\begin{lstlisting}[language=java,frame=single, float=h!, caption={Alt operátort tartalmazó scenario.},captionpos=b,label=tpsc_alt]
specification Bank {
...
\begin{lstlisting}[language=java,frame=single, float=h!, caption={Alt operátort tartalmazó scenario never claim leírása.},captionpos=b,label=tpsc_alt_nc]
bool success = true;
