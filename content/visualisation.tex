...
Előszőr kiegészítettem az alkalmazást \textit{TPSC} elemek vizualizációjával.
Egy \textit{XML} generátor előállítja a specifikáció \textit{XMLs} leírását, amit a \textit{Sirius} alkalmazás képes feldolgozni és előállítani a hozzá tartozó diagramot.
...
\begin{figure}[!ht]
    ...
    \caption{\textit{Sirius} által előálított szcenárió diagram.}
...
Egy ilyen diagramot mutatbe a \ref{sirius_diagram} ábra.
...
\begin{figure}[!ht]
    ...
    \caption{\textit{Sirius} alkalmazáshoz tartozó model \textit{ER} diagramja.}
    \label{er_diagram}
\end{figure}
...
Ilyen operatárokat a \ref{sirius_operators} diagramon lehet megtekínteni.